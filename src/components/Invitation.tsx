    ...
    return (
        <div className="invitation">
            ...
            <div className="invitation ye-olde">
                ...
                And furthermost, yer musteth informeth me of thines (and thines possible supplicant's) intent to participateth in mine most holy midnight sacrament, so that the proper ritualistic components might be preparedethed for thine.
                Finalmost, I must remind ye that as thines most beneficent and engraced ruler ye are free of the burden of any offerings in the great celebration. Rejoice!<br/><br/>
            ...
            <div className="invitation modern">
                ...
                Typically, costume-based events are the bane existance, and frankly this is no different. So if you're not it, rest assured I won't be doing it again for another ten years.<br/><br/>
                ...
                We hang out and have dinner and then - if you've got the strength for it - at midnight we enjoy my finest culinary creation, passed down through my family: <b><i>pancakes</i></b> (with caramel sauce, and other toppings probably).
                And in case you didn't get it from the other side of the invitation, the time is non-negotiable.<br/><br/>

                Please let me know if you intend to show up at all, and also if you intend to stay until midnight for pancakes.
                Lemme know if you wanna bring a plus-one, and it should be fine as long as we're not getting too crowded. Also, as I say every year, don't bother with any sort gift, you're appreciated as is.
                Oh, and I moved about a year ago, so if you need to know where I live now, lemme know and I'll update you.<br/><br/>
